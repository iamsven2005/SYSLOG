...
import { Building2, Mail, Phone, Globe, MapPin, ArrowLeft, Edit } from "lucide-react"
...
import { ProjectStatus } from "@/prisma/generated/main"
          ...
          <CardContent>
            <dl className="grid grid-cols-1 gap-4 text-sm">
              <div className="flex items-center gap-2">
                ...
                <dd>
                  <span
                    className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold ${company.type === "CONTRACTOR"
...
{company.projects?.filter((p) => p.project.status === ProjectStatus.PLANNING).length || 0} active
                </p>
              </div>
