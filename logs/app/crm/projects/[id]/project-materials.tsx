/*
 * project-materials.tsx - 2025-05-26 by sven.tan
 *
 * Description:
 *   Displays and manages materials for a specific project, including:
 *   - Material listing in a table view
 *   - Add, edit, and delete actions per material
 *   - Integration with vendor ordering flow via "Create Order"
 *   - Confirmation dialogs for deletion
 *
 * Props:
 *   - projectId: ID of the project to which the materials belong
 *   - materials: Array of materials, each extending BridgeMaterial and including associated orders
 *
 * Features:
 *   - Table with columns for material name, spec, quantity, unit, estimated cost, and order count
 *   - Action menu (dropdown) for each row: Create Order, Edit, Delete
 *   - AlertDialog for delete confirmation with warnings for associated orders
 *   - Optional Dialog (prepped) for assigning material to vendor (not yet triggered)
 *
 * Dependencies:
 *   - UI: Table, Card, Button, DropdownMenu, AlertDialog, Dialog
 *   - Icons: Lucide (Plus, MoreHorizontal, Pencil, Trash2, ShoppingCart)
 *   - Routing: Next.js Link, useRouter for navigation and refresh
 *   - Actions: deleteMaterial from crm/actions/materials
 */
